...
import NearbyLocations from "@/templates/design8/components//NearbyLocations";
                                ...
                                {visibleLocations.map((loc) => (
                                    ...
                                    <li key={loc.slug}>
                                        ...
                                        <button
                                            ...
                                            className={`group w-full flex items-center gap-3 px-4 py-3 rounded-2xl border transition-all duration-300 ${activeLocation ===
                                                loc.location
                                        ...
                                        >
                                            ...
                                            <MapPin
                                                size={18}
                                                className={`shrink-0 ${activeLocation ===
                                                    loc.location
                                                    ? "text-white"
                                                    : "text-[#76153C]"
                                                    }`}
