...
export default function Footer() {
  return (
    <footer className="relative bg-[#0f0f0f] text-white overflow-hidden">
      {/* GOLD GLOW */}
      <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-[#d4af37]/10 blur-3xl rounded-full" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70">
              ...
              <li><Link href="/dealers" className="hover:text-[#d4af37]">Dealers</Link></li>
              <li><Link href="/blogs" className="hover:text-[#d4af37]">Blogs</Link></li>
