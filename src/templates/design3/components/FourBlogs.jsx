  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-10">
        <div className="w-10 h-10 border-4 border-[#5E23DC]/30 border-t-[#5E23DC] rounded-full animate-spin"></div>
      </div>
    );
  }
          ...
          {fourBlogs.map((post, i) => {
            ...
            return (
              ...
              >
                ...
                {/* TITLE */}
                <h3 className="text-base font-semibold text-[#5E23DC] line-clamp-2">
                  {titleText}
                </h3>
