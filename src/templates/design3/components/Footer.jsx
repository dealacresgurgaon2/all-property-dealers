...
export default function Footer() {
  return (
    <footer className="relative bg-[#422c18] text-[#f2e8e1] overflow-hidden">
      ...
      {/* SOFT BROWN GLOW */}
      <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[520px] h-[520px] bg-[#f2e8e1]/10 blur-3xl rounded-full" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-[#f2e8e1]/80 leading-7 mb-6">
          ...
          <div>
            ...
            <ul className="space-y-3 text-[#f2e8e1]/80">
              <li><Link href="/" className="hover:text-[#d4a373]">Home</Link></li>
              <li><Link href="/about" className="hover:text-[#d4a373]">About Us</Link></li>
              <li><Link href="/dealers" className="hover:text-[#d4a373]">Dealers</Link></li>
              <li><Link href="/blogs" className="hover:text-[#d4a373]">Blogs</Link></li>
              <li><Link href="/contact" className="hover:text-[#d4a373]">Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-[#f2e8e1]/80">
            ...
            <div className="mt-6 inline-block px-4 py-2 rounded-full bg-[#f2e8e1]/10 border border-[#f2e8e1]/20 text-xs">
        ...
        {/* DIVIDER */}
        <div className="my-12 h-px bg-gradient-to-r from-transparent via-[#f2e8e1]/30 to-transparent" />

        {/* BOTTOM BAR */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-[#f2e8e1]/70">
...
function LocationIcon() {
  return (
    <svg className="w-5 h-5 text-[#d4a373]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
