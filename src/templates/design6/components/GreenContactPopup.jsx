  ...
  return ReactDOM.createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-[92%] max-w-lg p-7 z-[10000]">
        ...
        {/* HEADER */}
        <div className="flex justify-between items-center mb-5 border-b border-green-500/30 pb-3">
          <h2 className="text-xl font-extrabold text-green-700 tracking-wide">
            Contact Form
          </h2>
