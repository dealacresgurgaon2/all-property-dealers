...
export default function Footer() {
  return (
    <footer className="relative bg-[#0f172a] text-white overflow-hidden">
      {/* SOFT ORANGE GLOW */}
      <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[520px] h-[520px] bg-[#ff7a1a]/15 blur-3xl rounded-full" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70">
              <li><Link href="/" className="hover:text-[#ff7a1a]">Home</Link></li>
              <li><Link href="/about" className="hover:text-[#ff7a1a]">About Us</Link></li>
              <li><Link href="/dealers" className="hover:text-[#ff7a1a]">Dealers</Link></li>
              <li><Link href="/blogs" className="hover:text-[#ff7a1a]">Blogs</Link></li>
              <li><Link href="/contact" className="hover:text-[#ff7a1a]">Contact</Link></li>
            </ul>
          </div>
        ...
        {/* DIVIDER */}
        <div className="my-12 h-px bg-gradient-to-r from-transparent via-[#ff7a1a]/40 to-transparent" />

        {/* BOTTOM BAR */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/60">
          <p>© {new Date().getFullYear()} PropertyDealer. All rights reserved.</p>
          <div className="flex gap-6">
            <Link href="/privacy" className="hover:text-[#ff7a1a]">Privacy Policy</Link>
            <Link href="/terms" className="hover:text-[#ff7a1a]">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
...
function SocialIcon({ children }) {
  return (
    <span className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white transition-all duration-300 hover:bg-[#ff7a1a] hover:text-white hover:-translate-y-1 hover:shadow-lg">
      {children}
    </span>
  );
}
...
function LocationIcon() {
  return (
    <svg className="w-5 h-5 text-[#ff7a1a]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
