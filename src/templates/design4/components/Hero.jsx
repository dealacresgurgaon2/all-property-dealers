...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setCounts({
        listings: Math.min(
          Math.round((targets.listings / 60) * step),
          targets.listings
        ),

        cities: Math.min(
          Math.round((targets.cities / 60) * step),
          targets.cities
        ),

        years: Math.min(
          Math.round((targets.years / 60) * step),
          targets.years
        ),
      });
  ...
  const inputClass =
    ...
    "border border-[#e7a7b7] focus:ring-2 focus:ring-[#D02752] " +
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-gray-800 space-y-6">
            ...
            <p className="text-lg text-gray-600 max-w-lg">
              ...
              Discover luxury flats, commercial spaces &
...
function Stat({ value, label }) {
  ...
  return (
    ...
    <div className="text-center">
      ...
      <div className="text-2xl font-bold text-[#D02752]">
        {value}
      </div>
