...
export default function Footer() {
  return (
    <footer className="relative bg-[#0b1f33] text-white overflow-hidden">
      {/* SOFT BLUE GLOW */}
      <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[520px] h-[520px] bg-[#1e40af]/20 blur-3xl rounded-full" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70">
              <li><Link href="/" className="hover:text-[#38bdf8]">Home</Link></li>
              <li><Link href="/about" className="hover:text-[#38bdf8]">About Us</Link></li>
              <li><Link href="/dealers" className="hover:text-[#38bdf8]">Dealers</Link></li>
              <li><Link href="/blogs" className="hover:text-[#38bdf8]">Blogs</Link></li>
...
function SocialIcon({ children }) {
  return (
    <span className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white transition-all duration-300 hover:bg-[#38bdf8] hover:text-[#0b1f33] hover:-translate-y-1 hover:shadow-lg">
      {children}
    </span>
  );
}
